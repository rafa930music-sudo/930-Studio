...
export const CanvasContextMenu: React.FC<CanvasContextMenuProps> = ({
  ...
  return (
    <>
      ...
      <div
        className="fixed z-50 w-52 rounded-2xl bg-[#12121A] border border-white/15 p-1.5 shadow-[0_15px_40px_rgba(0,0,0,0.9)] backdrop-blur-2xl animate-fade-in text-white text-xs font-bold space-y-0.5"
